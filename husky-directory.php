...
function load_other_resources() {
	...
	wp_register_script('lazyload-js', 'https://cdnjs.cloudflare.com/ajax/libs/vanilla-lazyload/8.9.0/lazyload.min.js', 'jquery');
	wp_enqueue_script('lazyload-js');

	wp_register_script('isotope-js', 'https://cdnjs.cloudflare.com/ajax/libs/jquery.isotope/2.2.2/isotope.pkgd.min.js', 'jquery');
